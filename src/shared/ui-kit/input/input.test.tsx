...
describe("Input component", () => {
  test("renders correctly", () => {
    ...
    const { getByLabelText, container } = render(<Input onChange={jest.fn()} placeholder={"User name"}
      label={label} />);
  ...
  test("calls onChange", async () => {
    ...
    const { getByLabelText, container } = render(<Input onChange={onChange} placeholder={"User name"} label={label} />);
